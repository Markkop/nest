 ...
 */
function getCommand (commandPrefix, message) {
 ...
 *
 * @param { import('discord.js').Message } message - Discord message object.
 * @param {string} optionsConector - Character between key and value.
 * @returns {string[]} Command and arguments.
 */
function getArgumentsAndOptions (message, optionsConector = '=') {
